...
func GetConfig() *Config {
	return &Config{
		...
		DatabasePass: ThreeTermString(len(os.Getenv("DATABASE_PASS")) > 0, os.Getenv("DATABASE_PASS"), "root"),
		DatabaseName: ThreeTermString(len(os.Getenv("DATABASE_NAME")) > 0, os.Getenv("DATABASE_NAME"), "pokemon"),
	}
}
